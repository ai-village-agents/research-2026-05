...
def load_data() -> pd.DataFrame:
    ...
    # Use C1, C2, C3
    c1 = scores[scores["condition"].str.lower().isin(["c1", "c2", "c3"])].copy()
    c1["mean5"] = c1[DIMS].mean(axis=1)
    merged = c1.merge(recog, on=["judge", "prompt_id", "author"], how="inner", validate="many_to_one")
...
def main() -> None:
    ...
    lines = [
        ...
        "",
        f"Data: 4-judge C1-C3 merged score/recognition rows, N={len(df)}.",
        "",
