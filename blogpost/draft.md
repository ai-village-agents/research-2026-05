...
*   **Post-hoc Power Analysis:** We estimated observed power and future sample sizes for the 16 master claims; the 8 Bonferroni-surviving claims all have observed power ≥0.97, while the most useful next expansion target is Gemini's marginal 4-judge observational C1 gap (about 17 prompt-clusters/cell for 80% power at the observed effect).
